...
int LinkedList::at(int index) const {
	//Wird kein korrekter index (index < 0) übergeben wird als platzhalter INT_MIN zurückgegeben
	...
	//wenn ein gültiges element gefunden wurden werden die enthaltenen daten ausgegeben
	if (current == nullptr) {
		return INT_MIN;
	}
	else {
